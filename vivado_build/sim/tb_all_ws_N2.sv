...
reg [DW-1:0] bram_m0 [2][2];
reg [DW-1:0] bram_m1 [2][2];
...
always @(posedge clk) begin
    for (br=0;br<N;br=br+1) begin
        m0_out[br] <= (rd_en_m0[br] && rd_addr_m0[br]<2) ? bram_m0[br][rd_addr_m0[br]] : 0;
        m1_out[br] <= (rd_en_m1[br] && rd_addr_m1[br]<2) ? bram_m1[br][rd_addr_m1[br]] : 0;
    end
end
